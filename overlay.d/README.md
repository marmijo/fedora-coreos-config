...
- Add udev rules for:
  - SRIOV networking on Azure. The udev rules are also
...
bits to include the rules in the initramfs too.
  - NVMe-backed Azure Managed Disks. This is only needed in <42. The 
`azure-vm-utils` package installs these rules and is included in >=42
